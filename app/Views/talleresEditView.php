...
<div class="row">
    <div class="col-12">
        ...
        <form action="<?php echo baseUrl(); ?>/talleres/actualizar" method="post" enctype="multipart/form-data"
            id="form1">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="id_distribuidores" name="id_distribuidores"
                    placeholder="Id distribuidores" value="<?= $datos["id_distribuidores"]; ?>">
            </div>
            <!-- <div class="mb-3">
                <label for="provincias" class="form-label">Provincias</label>
                <span id="provincias_error" class="text-danger"></span>
                <input type="text" class="form-control" id="provincias" name="provincias" placeholder="Provincias"
                    value="<?= $datos["provincias"]; ?>">
            </div> -->
