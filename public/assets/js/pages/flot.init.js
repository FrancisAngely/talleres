! function (b) {
    ...
    o.prototype.createPlotGraph = function (o, a, t, r, e, l, i, s) {
        ...
        for (var a = [], t = 0; t < this.$realData.length; ++t) a.push([t, this.$realData[t]]);
        return a
        ...
        this.createPlotGraph("#website-stats", [[0, 5], [1, 8], [2, 10], [3, 12], [4, 9], [5, 5], [6, 7], [7, 9], [8, 8], [9, 16], [10, 14], [11, 12], [12, 10]], [[0, 2], [1, 4], [2, 7], [3, 9], [4, 6], [5, 3], [6, 10], [7, 8], [8, 5], [9, 14], [10, 10], [11, 10], [12, 8]], [[0, 1], [1, 3], [2, 6], [3, 7], [4, 4], [5, 2], [6, 8], [7, 6], [8, 4], [9, 10], [10, 8], [11, 14], [12, 5]], ["Google", "Yahoo", "Facebbok"], ["#4bd396", "#f5707a", "#188ae2"], "rgba(108, 120, 151, 0.1)", "transparent");
        this.createPlotDotGraph("#website-stats1", [[0, 2], [1, 4], [2, 7], [3, 9], [4, 6], [5, 3], [6, 10], [7, 8], [8, 5], [9, 14], [10, 10], [11, 10], [12, 8]], [[0, 1], [1, 3], [2, 6], [3, 7], [4, 4], [5, 2], [6, 8], [7, 6], [8, 4], [9, 10], [10, 8], [11, 14], [12, 5]], ["Visits", "Page views"], ["#4bd396", "#f5707a"], "rgba(108, 120, 151, 0.1)", "transparent");
        this.createPieGraph("#pie-chart #pie-chart-container", ["Series 1", "Series 2", "Series 3", "Series 4"], [20, 30, 15, 32], ["#188ae2", "#4bd396", "#f5707a", "#f9c851"]);
        var a = this.createRealTimeGraph("#flotRealTime", this.randomData(), ["#64b0f2"]);
        a.draw();
        var t = this;
        ! function o() {
            a.setData([t.randomData()]), a.draw(), setTimeout(o, (b("html").hasClass("mobile-device"), 500))
        }();
        this.createDonutGraph("#donut-chart #donut-chart-container", ["Series 1", "Series 2", "Series 3", "Series 4"], [35, 20, 10, 20], ["#ff9800", "#8d6e63", "#26a69a", "#7fc1fc"]);
        ...
        this.createCombineGraph("#combine-chart #combine-chart-container", [[0, "22h"], [1, ""], [2, "00h"], [3, ""], [4, "02h"], [5, ""], [6, "04h"], [7, ""], [8, "06h"], [9, ""], [10, "08h"], [11, ""], [12, "10h"], [13, ""], [14, "12h"], [15, ""], [16, "14h"], [17, ""], [18, "16h"], [19, ""], [20, "18h"], [21, ""], [22, "20h"], [23, ""]], ["Last 24 Hours", "Last 48 Hours", "Difference"], o);
        for (var r = [], e = 0; e <= 10; e += 1) r.push([e, parseInt(30 * Math.random())]);
        var l = [];
        for (e = 0; e <= 10; e += 1) l.push([e, parseInt(30 * Math.random())]);
        var i = [];
        for (e = 0; e <= 10; e += 1) i.push([e, parseInt(30 * Math.random())]);
        var s = new Array;
        s.push({
            label: "Series One",
            data: r,
        ...
        }, ["#26a69a", "#f5707a", "#ebeff2"], s);
        var n = [],
            c = [];
        for (e = 0; e < 12; e += .2) n.push([e, Math.sin(e + 0)]), c.push([e, Math.cos(e + 0)]);
        var h = [{
            data: n,
            label: "Google"
        }, {
    ...
    }, b.FlotChart = new o, b.FlotChart.Constructor = o
}(window.jQuery),
function (o) {
    "use strict";
